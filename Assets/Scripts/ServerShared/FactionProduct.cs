...
[DatabaseCategory("Items"), Inspectable, MessagePackObject, JsonObject(MemberSerialization.OptIn)]
public class FactionProductData : DatabaseEntry, INamedEntry
{
    ...
    [InspectableDatabaseLink(typeof(CraftedItemData)), JsonProperty("design"), Key(3)]
    public Guid Design;

    [InspectableDatabaseLink(typeof(Faction)), JsonProperty("manufacturer"), Key(4)]
