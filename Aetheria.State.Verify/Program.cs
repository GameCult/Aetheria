...
static void RequireUnitySharedDocumentAccessorErgonomics(string root)
{
    ...
    {
        throw new InvalidOperationException(
            "AetheriaClientState must expose generic managed reactive access plus latest accessors for shared Unity documents: " +
            string.Join(", ", missingClientSymbols));
    }
...
static void RequireRuntimeStateReaderOwnsUnityStateAcquisition(string root)
{
    ...
    {
        throw new InvalidOperationException(
            "AetheriaClientState must compose current observed daemon state from direct managed reactive typed documents: " +
    ...
    {
        throw new InvalidOperationException(
            "Daemon runtime document tests must teach observed daemon sampling through direct reactive daemon documents and CurrentObservedDaemon().");
    }
