...
const { installEveProviderBridge } = require("@gamecult/eve-electron/preload");
...
installEveProviderBridge({
  contextBridge,
  ipcRenderer,
  channels: {
    providerAdvertisement: channels.eveProviderAdvertisement,
    surface: channels.eveSurface,
    document: channels.eveDocument,
    submitCommand: channels.submitEveCommand,
    windowControl: channels.windowControl,
  },
});
